    ...
    <div className="dashboard">
      <div className="timedisplay">
        <div className="welcome-message">
          <p>
          Welcome to Stock Hustle – your trusted guide to mastering the stock market. Learn, invest, and grow smarter, one hustle at a time!
          </p>
        </div>
      ...
      <div className="watchlist">
        <h2 className="watchlist-heading text-black">Watchlist</h2>
